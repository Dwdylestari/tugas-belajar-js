function saveData() {
  ...
  if (storageType == "session") {
    ...
    document.cookie =
      "firstName=" + firstName + ";expires=" + expiryDate.toUTCString();
    document.cookie =
      "lastName=" + lastName + ";expires=" + expiryDate.toUTCString();
    document.cookie =
      "gender=" + gender + ";expires=" + expiryDate.toUTCString();
    document.cookie =
      "address=" + address + ";expires=" + expiryDate.toUTCString();
  }
